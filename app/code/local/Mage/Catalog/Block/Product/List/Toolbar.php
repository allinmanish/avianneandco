...
class Mage_Catalog_Block_Product_List_Toolbar extends Mage_Core_Block_Template
{
    ...
    public function setCollection($collection)
    {
        ...
        if ($this->getCurrentOrder()) {
        	$c_order = (empty($_GET["order"]))?"rank":$this->getCurrentOrder();
        	$c_direction = (empty($_GET["dir"]))?"desc":$this->getCurrentDirection();
            $this->_collection->setOrder($c_order, $c_direction);
        }
        return $this;
    }
    ...
    public function getLimit()
    {
        ...
        else {if ($limit && isset($limits[$limit])) {
