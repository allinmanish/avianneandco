        ...
        $ratesRequest = array(
            ...
            'RequestedShipment' => array(
                ...
                'RequestedPackageLineItems' => array(
                    '0' => array(
                        'Weight' => array(
                            'Value' => ((float)$r->getWeight() ? (float)$r->getWeight() : 1),
                            'Units' => 'LB'
                        ),
                        'GroupPackageCount' => 1,
                    )
            ...
            'VariableOptions' => array('SATURDAY_DELIVERY')
        );
            ...
            if ($response->HighestSeverity == 'FAILURE' || $response->HighestSeverity == 'ERROR') {
                ...
                if (is_array($response->RateReplyDetails)) {
                    foreach ($response->RateReplyDetails as $rate) {
                        ...
                        if (isset($rate->AppliedOptions) && !empty($rate->AppliedOptions)) {
                        	$serviceName .= '_' . $rate->AppliedOptions;
                        }
...
//// WSM update - fixed prices
        if (isset($priceArr['FEDEX_2_DAY'])) 
        	$priceArr['FEDEX_2_DAY'] = 0.00;
        if (isset($priceArr['PRIORITY_OVERNIGHT'])) 
        	$priceArr['PRIORITY_OVERNIGHT'] = 35.00;
        if (isset($priceArr['INTERNATIONAL_ECONOMY']))
        	$priceArr['INTERNATIONAL_ECONOMY'] = 45.00;
        if (isset($priceArr['INTERNATIONAL_PRIORITY']))
        	$priceArr['INTERNATIONAL_PRIORITY'] = 45.00;
    ...
    {
//// WSM update - changed names
        $codes = array(
            'method' => array(
                'EUROPE_FIRST_INTERNATIONAL_PRIORITY' => Mage::helper('usa')->__('Europe First Priority'),
                'EUROPE_FIRST_INTERNATIONAL_PRIORITY_SATURDAY_DELIVERY' => Mage::helper('usa')->__('Europe First Priority - Saturday Delivery'),
                'FEDEX_1_DAY_FREIGHT'                 => Mage::helper('usa')->__('1 Day Freight'),
                'FEDEX_1_DAY_FREIGHT_SATURDAY_DELIVERY'                 => Mage::helper('usa')->__('1 Day Freight - Saturday Delivery'),
                'FEDEX_2_DAY_FREIGHT'                 => Mage::helper('usa')->__('2 Day Freight'),
                'FEDEX_2_DAY_FREIGHT_SATURDAY_DELIVERY'                 => Mage::helper('usa')->__('2 Day Freight - Saturday Delivery'),
//                'FEDEX_2_DAY'                         => Mage::helper('usa')->__('2 Day'),
                'FEDEX_2_DAY'                         => Mage::helper('usa')->__('FedEx 2 Day Air'),
                'FEDEX_2_DAY_SATURDAY_DELIVERY'                         => Mage::helper('usa')->__('FedEx 2 Day Air - Saturday Delivery'),
                'FEDEX_2_DAY_AM'                      => Mage::helper('usa')->__('2 Day AM'),
                'FEDEX_2_DAY_AM_SATURDAY_DELIVERY'                      => Mage::helper('usa')->__('2 Day AM - Saturday Delivery'),
                'FEDEX_3_DAY_FREIGHT'                 => Mage::helper('usa')->__('3 Day Freight'),
                'FEDEX_3_DAY_FREIGHT_SATURDAY_DELIVERY'                 => Mage::helper('usa')->__('3 Day Freight - Saturday Delivery'),
                'FEDEX_EXPRESS_SAVER'                 => Mage::helper('usa')->__('Express Saver'),
                'FEDEX_EXPRESS_SAVER_SATURDAY_DELIVERY'                 => Mage::helper('usa')->__('Express Saver - Saturday Delivery'),
                'FEDEX_GROUND'                        => Mage::helper('usa')->__('Ground'),
                'FEDEX_GROUND_SATURDAY_DELIVERY'                        => Mage::helper('usa')->__('Ground - Saturday Delivery'),
//                'FIRST_OVERNIGHT'                     => Mage::helper('usa')->__('First Overnight'),
                'FIRST_OVERNIGHT'                     => Mage::helper('usa')->__('Fedex Overnight First'),
                'FIRST_OVERNIGHT_SATURDAY_DELIVERY'   => Mage::helper('usa')->__('Fedex Overnight First - Saturday Delivery'),
                'GROUND_HOME_DELIVERY'                => Mage::helper('usa')->__('Home Delivery'),
                'GROUND_HOME_DELIVERY_SATURDAY_DELIVERY'                => Mage::helper('usa')->__('Home Delivery - Saturday Delivery'),
//                'INTERNATIONAL_ECONOMY'               => Mage::helper('usa')->__('International Economy'),
                ...
                'INTERNATIONAL_ECONOMY_SATURDAY_DELIVERY'               => Mage::helper('usa')->__('Fedex International Economy - Saturday Delivery'),
                'INTERNATIONAL_ECONOMY_FREIGHT'       => Mage::helper('usa')->__('Intl Economy Freight'),
                'INTERNATIONAL_ECONOMY_FREIGHT_SATURDAY_DELIVERY'       => Mage::helper('usa')->__('Intl Economy Freight - Saturday Delivery'),
                'INTERNATIONAL_FIRST'                 => Mage::helper('usa')->__('International First'),
                'INTERNATIONAL_FIRST_SATURDAY_DELIVERY'                 => Mage::helper('usa')->__('International First - Saturday Delivery'),
                'INTERNATIONAL_GROUND'                => Mage::helper('usa')->__('International Ground'),
                'INTERNATIONAL_GROUND_SATURDAY_DELIVERY'                => Mage::helper('usa')->__('International Ground - Saturday Delivery'),
//                'INTERNATIONAL_PRIORITY'              => Mage::helper('usa')->__('International Priority'),
                ...
                'INTERNATIONAL_PRIORITY_SATURDAY_DELIVERY'              => Mage::helper('usa')->__('FedEx International Priority - Saturday Delivery'),
                'INTERNATIONAL_PRIORITY_FREIGHT'      => Mage::helper('usa')->__('Intl Priority Freight'),
                'INTERNATIONAL_PRIORITY_FREIGHT_SATURDAY_DELIVERY'      => Mage::helper('usa')->__('Intl Priority Freight - Saturday Delivery'),
//                'PRIORITY_OVERNIGHT'                  => Mage::helper('usa')->__('Priority Overnight'),
                'PRIORITY_OVERNIGHT'                  => Mage::helper('usa')->__('FedEx Overnight Delivery'),
                'PRIORITY_OVERNIGHT_SATURDAY_DELIVERY'                  => Mage::helper('usa')->__('FedEx Overnight Delivery - Saturday Delivery'),
                'SMART_POST'                          => Mage::helper('usa')->__('Smart Post'),
                'SMART_POST_SATURDAY_DELIVERY'                          => Mage::helper('usa')->__('Smart Post - Saturday Delivery'),
//                'STANDARD_OVERNIGHT'                  => Mage::helper('usa')->__('Standard Overnight'),
                'STANDARD_OVERNIGHT'                  => Mage::helper('usa')->__('Fedex Overnight Standard'),
                'STANDARD_OVERNIGHT_SATURDAY_DELIVERY'                  => Mage::helper('usa')->__('Fedex Overnight Standard - Saturday Delivery'),
                'FEDEX_FREIGHT'                       => Mage::helper('usa')->__('Freight'),
                'FEDEX_FREIGHT_SATURDAY_DELIVERY'                       => Mage::helper('usa')->__('Freight - Saturday Delivery'),
                'FEDEX_NATIONAL_FREIGHT'              => Mage::helper('usa')->__('National Freight'),
                'FEDEX_NATIONAL_FREIGHT_SATURDAY_DELIVERY'              => Mage::helper('usa')->__('National Freight - Saturday Delivery'),
            ),
//Fedex Overnight for Saturday Delivery
            'dropoff' => array(
    ...
    protected function _formShipmentRequest(Varien_Object $request)
    {
        ...
        foreach ($productCollection as $product) {
            $countriesOfManufacture[] = $product->getCountryOfManufacture() ? $product->getCountryOfManufacture() : 'US';
        }
        
		$saturday = false;
        if (strpos($request->getShippingMethod(), 'SATURDAY_DELIVERY')===false) {
        	$ServiceType = $request->getShippingMethod();
        } else {
        	$ServiceType = str_replace("_SATURDAY_DELIVERY","",$request->getShippingMethod());
        	$saturday = true;
        }
        ...
        $requestClient = array(
            'RequestedShipment' => array(
                ...
                'Shipper' => array(
                    'Contact' => array(
//// WSM update - changed return address
//                        'PersonName' => $request->getShipperContactPersonName(),
                        'PersonName' => "Israel Aranbayev",
        ...
        if (!empty($request->getOrderShipment()->getInsuredAmount())) {
        	$requestClient['RequestedShipment']['RequestedPackageLineItems']['InsuredValue'] = array(
        			'Amount' => (float) $request->getOrderShipment()->getInsuredAmount(),
        			'Currency' => $this->getCurrencyCode()
        	);
        }
        if ($saturday) {
