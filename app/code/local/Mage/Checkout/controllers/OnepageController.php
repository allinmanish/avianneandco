...
class Mage_Checkout_OnepageController extends Mage_Checkout_Controller_Action
{
    ...
    public function successAction()
    {
        ...
        /* Remove guest checkout data by WSM */
        if(isset($_COOKIE['guest_checkout_billing'])) {
        	setcookie("guest_checkout_billing", "", time()-3600, '/');
        }
        if(isset($_COOKIE['guest_checkout_shipping'])) {
        	setcookie("guest_checkout_shipping", "", time()-3600, '/');
        }
        /* Remove guest checkout data by WSM */
...
//            $data = $this->_filterPostData($postData);
            ...
            /* Save guest checkout data by WSM */
            if(empty($customerAddressId)) {
            	setcookie("guest_checkout_billing", serialize($data), time()+60*60*24*30, '/');
            }
            /* Save guest checkout data by WSM */
    ...
    public function saveShippingAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            /* Save guest checkout data by WSM */
            if(empty($customerAddressId)) {
            	setcookie("guest_checkout_shipping", serialize($data), time()+60*60*24*30, '/');
            }
            /* Save guest checkout data by WSM */
