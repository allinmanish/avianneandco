...
//         		'sortable'  => false,
                ...
                'renderer' => 'Mage_Adminhtml_Block_Sales_Order_Renderer_Status'
                //'frame_callback' => array(Mage::getResourceSingleton('eye4fraud_connector/status_collection'),'addStatusDescription')
        ));
...
//         				)
    ...
    protected function fraudFilter($collection, $column)
    {
        ...
        $this->getCollection()->addAttributeToFilter('eye4fraud_stat.status', array('like' => 'I'));
    	...
    	else
    	{
    		...
    		$this->getCollection()->addAttributeToFilter('eye4fraud_stat.status', array(array('like' => 'F'),array('like' => 'C'),array('like' => 'A'),array('like' => 'P'),array('like' => 'E')));
    	}
    	return $this;
    }
