    ...
    public function requestShippingRates(Mage_Sales_Model_Quote_Item_Abstract $item = null)
    {
        ...
        if ($result) {
            ...
            foreach ($shippingRates as $shippingRate) {
                ...
                /* i.gnedych@websitemovers.com */
                if (in_array($this->getRegionId(),array(6,7,8,9,10,11))&&($rate->getCode()!='armedshipping_ARMED_SHIPPING')) {
                	continue;
                } elseif (!in_array($this->getRegionId(),array(6,7,8,9,10,11))&&($rate->getCode()=='armedshipping_ARMED_SHIPPING')) {
                	continue;
                }
                /* i.gnedych@websitemovers.com */
                if (!$item) {
