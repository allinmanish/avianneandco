...
// WSM - 11/02/2012 - The following pricing logic has been updated for Christmas
/*            
            if ($request->getPackageValueWithDiscount()<300) {
            
                $shippingPrice = '15.00';
                
                $method->setCarrierTitle('UPS Shipping');
                $method->setMethodTitle('2 Day Air');
...
// WSM - 11/02/2012 - End of updated pricing logic
