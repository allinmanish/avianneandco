...
class Mage_Page_Block_Html_Breadcrumbs extends Mage_Core_Block_Template
{
    ...
    protected function _toHtml()
    {
    	...
    	if($product instanceof Mage_Catalog_Model_Product) {
    		...
    		$_category = $category_model->load(array_pop($product->getCategoryIds()));
    		$my_crumb = array(
    				'label' => $_category->getName(),
    				'title' => 'Go to '.$_category->getName(),
    		...
    		$prod = $this->_crumbs['product'];
    		$home = $this->_crumbs['home'];
    		
    		$this->_crumbs = array();
    		
    		$this->_crumbs['home'] = $home;
    		$this->_crumbs['category'] = $my_crumb;
    		$this->_crumbs['product'] = $prod;
    	}
