...
//            Mage::app()->getStore()->setConfig('design/theme/'.$type, $this->_mobileVal);
    ...
    public function predispatch($event) {
        ...
        if ($this->_helper()->getTargetPlatform() == self::TARGET_MOBILE && strpos($httpRequest->getRequestString(), '/blog/celebrity-diamond-jewelry')===false && strpos($httpRequest->getRequestString(), '/custom-diamond-jewelry-gallery')===false) {
