...
*/
class WSM_InternationalShipping_Model_Carrier_Internationalshipping extends Mage_Shipping_Model_Carrier_Abstract
{

  protected $_code = 'internationalshipping';
  ...
  public function collectRates(Mage_Shipping_Model_Rate_Request $request)
  {
    ...
    $result = Mage::getModel('shipping/rate_result');
      ...
      $method->setMethod("INTERNATIONAL_SHIPPING");
      $method->setMethodTitle("FedEx International Shipping");
