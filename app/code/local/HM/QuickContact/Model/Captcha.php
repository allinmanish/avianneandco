<?php
define("RECAPTCHA_API_SERVER1", "http://www.google.com/recaptcha/api");
define("RECAPTCHA_API_SECURE_SERVER1", "https://www.google.com/recaptcha/api");
define("RECAPTCHA_VERIFY_SERVER1", "www.google.com");
...
class HM_QuickContact_Model_Captcha
{
	...
	public function recaptcha_get_html ($pubkey, $error = null, $use_ssl = false)
	{
		...
		if ($use_ssl) {
					$server = RECAPTCHA_API_SECURE_SERVER1;
			} else {
					$server = RECAPTCHA_API_SERVER1;
			}
	...
	public function recaptcha_check_answer ($privkey, $remoteip, $challenge, $response, $extra_params = array())
	{
		...
		if ($remoteip == null || $remoteip == '') {
			...
			$response = $this->_recaptcha_http_post (RECAPTCHA_VERIFY_SERVER1, "/recaptcha/api/verify",
											  array (
													 'privatekey' => $privkey,
													 'remoteip' => $remoteip,
													 'challenge' => $challenge,
