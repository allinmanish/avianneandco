...
class Idev_OneStepCheckout_Helper_Checkout extends Mage_Core_Helper_Abstract
{
	...
	{	
		...
		$items = array(
			...
			'general/enable_geoip', 'exclude_fields/exclude_city', 'exclude_fields/exclude_telephone',
			'exclude_fields/exclude_company', 'exclude_fields/exclude_fax', 'exclude_fields/exclude_region', 'exclude_fields/exclude_zip', 'exclude_fields/enable_comments',
            ...
            'registration/registration_mode', 'registration/registration_order_without_password'
		);	
	...
	{
		$temp = $this->temp;
		$temp2 = sha1(sha1(base64_decode('b25lc3RlcGNoZWNrb3V0')) . $_SERVER['SERVER_NAME']);
