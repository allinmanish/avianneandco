							    		 ...
							    		 <center>
								    		 ...
								    		 <img id="ringbigimage'.$row['stock_number'].'" src="';
...

												{
												 ...
												 $img = file_exists(config_item('base_path').'images/watches/'.$row['thumb']) ? config_item('base_url').'images/watches/'.$row['thumb'] : config_item('base_url').'images/rings/noimage.jpg';
