<?php class Rolex extends Controller {
...

	{
	    ...
	    $output = $this->load->view('rolex/index' , $data , true);
	...
	function search(){
	    ...
	    $output = $this->load->view('rolex/search' , $data , true);
	...
	function searchdiamonds(){
		...
		if(isset($_POST)){
			...
			if(isset($_POST['hid'])){
				...
				$output = $this->load->view('rolex/searchdiamonds' , $data , true);
			...
			$data['title'] = 'Search Earring Style';
			 ...
			 $output = $this->load->view('rolex/searchearringstyle' , $data , true);
	...
	<meta name="abstract" content="Diamond Rings, Wholesale Diamonds, Estate ROlex, Custom Engagement Rings, New York, Chicago, California, Boston, Las Vegas, Columbia, Montgomery">
	...
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">';
	    ...
	    $output = $this->load->view('rolex/diamondpendant' , $data , true);
	...
	function getpendantresult(){
		...
		$results = $this->rolexmodel->getPendants();
	...
	function getpendantsettingsresult($isPlatinum = '', $isYellowgold = '', $isWhitegold = '', $isSolitaire = '', $isThreestone = ''){
		...
		$results = $this->rolexmodel->getAllPendantSettings($isPlatinum, $isYellowgold, $isWhitegold, $isSolitaire, $isThreestone);
	...
	function pendantdetailsajax($id = '',$style = '' ){
		...
		$data['details'] = $this->rolexmodel->getPendentSettingsById($id); 

			

	    $output = $this->load->view('rolex/pendantsettingsdetails' , $data , true);		
	...
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">';
	    ...
	    $output = $this->load->view('rolex/threestonering' , $data , true);
...

	{
	    ...
	    $output = $this->load->view('rolex/bracelets' , $data , true);
	...
	function diamond(){
	    ...
	    $output = $this->load->view('rolex/diamondjewelry' , $data , true);
	...
	function earrings(){
	    ...
	    $output = $this->load->view('rolex/earrings' , $data , true);
	...
	function gold(){
		...
		$data['title'] = 'Gold Rolex';

	    $output = $this->load->view('rolex/gold' , $data , true);
	...
	function necklaces(){
	    ...
	    $output = $this->load->view('rolex/necklaces' , $data , true);
	...
	function pearls(){
		...
		$data['title'] = 'Pearl Rolex';

	    $output = $this->load->view('rolex/pearls' , $data , true);
	...
	function platinum(){
		...
		$data['title'] = 'Platinum Rolex';

	    $output = $this->load->view('rolex/platinum' , $data , true);
	...
	function silver(){
		...
		$data['title'] = 'Sterling Silver Rolex';

	    $output = $this->load->view('rolex/silver' , $data , true);
	...
	function watches(){
	    ...
	    $output = $this->load->view('rolex/watch' , $data , true);
	...
	function weddings(){
	    ...
	    $output = $this->load->view('rolex/weddings' , $data , true);
	...
	function earringdiamondsajax($lot = '',$lot2='', $settingsid = '',$addoption = ''){
	    ...
	    $output = $this->load->view('rolex/earringstonedetails' , $data , true);		
	...
	function earringdetailsview($addoption = '', $settingsid = '', $lot = '', $lot2 = ''){
		...
		$data['settingsdetails'] = $this->rolexmodel->getEarringSettingsById($settingsid);
	    ...
	    $output = $this->load->view('rolex/earringdetailsview' , $data , true);
	...
	function getStyleResult($shape ='', $metal = '', $style = ''){
		...
		if($metal != ''){
			...
			$earringsettings = $this->rolexmodel->getEarringSettingsByShapeMetal($shape, $metal);			
	...
	function getMetalHtml($shape = '' , $isajax = true){
		...
		if($shape == 'B'){
			...
			$returnhtml = '
							...
							<div class="commonheader">2. Select Your Metal</div>
		...
		if($shape == 'B'){
			...
			if($metal == 'platinum'){
				...
				$returnhtml = '
								...
								<div class="commonheader">3. Select Your Stylea</div>
	...
	function diamondstudearring(){
		...
		$data['collections'] = $this->rolexmodel->getCollectionNameBySection('Diamond Stud Earrings');

		

	    $output = $this->load->view('rolex/diamondstudearring' , $data , true);
	...
	function earringstuddetailsajax($stockno = '', $addoption = '',$price = ''){
		...
		$data['details'] = $this->rolexmodel->getAllByStock($stockno); 			

	    $output = $this->load->view('rolex/earringstuddetails' , $data , true);		
	...
	function pendantdetailsview($addoption = '',$lot = '', $settings = '', $sidestone1 = '', $sidestone2 = ''){
		...
		$data['title'] = 'Rolex: Pendant Details';

		$data['details'] = $this->rolexmodel->getPendentSettingsById($settings);
	    ...
	    $output = $this->load->view('rolex/pendantdetailsview' , $data , true);
