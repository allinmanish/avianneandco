...
Fancy Colored Diamonds">
	...
	function getringresults($isPave = true , $Solitaire = true , $Sidestone = true ,$platinum = true, $gold = true,$whitegold = true,$anniversary=true , $weddingband=true, $minprice = 0 , $maxprice = 1000000 , $shape = 'all', $page = 0,$isMarkt = '',$isErd = '',$isVatche = '',$isDaussi = '',$isAntique = '', $isThreestone = true, $isHalo = true, $isMatching = true, $lot = 0){
				...
				$results = $this->engagementmodel->getRings($start , $rp , $isPave   , $Solitaire  , $Sidestone ,$platinum  , $gold ,$whitegold,$anniversary, $weddingband, $minprice , $maxprice , $shape, $isMarkt, $isErd, $isVatche, $isDaussi, $isAntique, $isThreestone, $isHalo , $isMatching);
			...
			//	echo htmlspecialchars($paginlinks);
				...
				foreach ($results['result'] as $row) {
					//echo config_item('base_path').'images/rings/carat'.$row['carat_image'];
					//echo "<br />";
					$returnhtml .= '
				    				...
				    				'.$row['style'].' collection<br>				    				
						    		 ...
						    		 <div class="txtsmall"> $'.$row['price'].'-'.$row['metal'].'
						    		  ...
						    		  <div class="txtsmall"> $'.$row['yellow_gold_price'].'- Yellow Gold'.'

						    		 </div>
						    		  <div class="txtsmall"> $'.$row['white_gold_price'].'- White Gold'.'
