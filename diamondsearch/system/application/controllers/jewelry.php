						...
						<div class="commonheader white">2. Select Your Metal</div>
							...
							<div>
					   				...
					   				<div class="floatl smallbox txtcenter">
							   				...
							   				<label for="platinum"><img src="'.config_item('base_url').'images/tamal/jewelry/roundplat.jpg"></label> <br>
							   		...
							   		<div class="floatl smallbox txtcenter">
							   				...
							   				<label for="18kwhitegold"><img src="'.config_item('base_url').'images/tamal/jewelry/roundwg.jpg"></label> <br>
							   		...
							   		<div class="floatl smallbox txtcenter">
							   				...
							   				<label for="18kyellowgold"><img src="'.config_item('base_url').'images/tamal/jewelry/roundyg.jpg"></label> <br>
							...
							<div class="commonheader white">2. Select Your Metal</div>
					   		...
					   		<div>
					   				...
					   				<div class="floatl smallbox txtcenter">
							   				...
							   				<label for="platinum"><img src="'.config_item('base_url').'images/tamal/jewelry/princessplat.jpg"></label> <br>
							   		...
							   		<div class="floatl smallbox txtcenter">
							   				...
							   				<label for="18kyellowgold"><img src="'.config_item('base_url').'images/tamal/jewelry/princessyg.jpg"></label> <br>
							   		...
							   		<div class="floatl smallbox txtcenter">
							   				...
							   				<label for="18kwhitegold"><img src="'.config_item('base_url').'images/tamal/jewelry/princesswg.jpg"></label> <br>
