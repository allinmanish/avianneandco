  			...
  			<div class="column floatl">
	  			 ...
	  			 <div class="column floatr">		  				
	  				<div class="floatl">
                              ...
                              <form  action="/store/checkout/cart/addloose?product=6386&options[16625]=<?php echo $pandent ?>&options[16626]=<?php echo $lot ?>&options[16627]=<?php echo floatval($totalprice);?>" name="form1" method="post" target="_top">
                            <a href="javascript:void(0)" onclick="document.form1.submit()">add to basket</a>
                            </form>
                            </div>
