...
/*
			...
			$diamondprice = number_format(round($sidestone1['price']) + round($sidestone2['price']),',');
...
<div class="floatl pad05">
	  	...
	  	<div class="bodymid">
		  			...
		  			<div class="column floatl">
			  				...
			  				<p><b>Diamond Price:</b>$<?php echo $diamondprice;?>(<small><i>including both diamonds</i></small>)</p>
		  			</div>
		  			<div class="column floatl">
			  				<img src="<?php echo config_item('base_url');?>images/tamal/choose_02.jpg">
			  				<div class="floatl">
			  	      				<div class="floatl blurleft"></div>
			  	      				<div class="floatl bluemiddle"><a href="<?php echo config_item('base_url')?>jewelry/earringdetailsview/<?php echo $addoption;?>/<?php echo $settingsid;?>/<?php echo $sidestone1['lot'];?>/<?=$sidestone2['lot']?>">select this to earring</a></div>
