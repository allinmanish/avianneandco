			...
			<div>
					...
					<div align="center">
						 ...
						 <form name="" action="<?php echo config_item('base_url');?>admin/jewelries/<?php echo $action; echo ($action == 'edit') ? '/' .$id : '';?>" method="post" enctype="multipart/form-data" >
									...
									<div class="lebelfield floatl">Diamond Name:</div>
									<div class="inputfield floatl">
											<input type="text" name="name" value="<?php echo $name;?>" maxlength="15" /><?php echo form_error('name'); ?> 											
									</div>
									<div class="clear"></div>
									...
									<div class="inputfield floatl">
											<select class="commondropdown" name="collection" id="collection" onchange="setringtype()">	
												...
												<option value="Milano Collection">Milano Collection</option>
									...
									<div id="platinum_price">
											<div class="lebelfield floatl">Platinum Price:</div>
											<div class="inputfield floatl">
													<input type="text" name="platinum_price" value="<?php echo $platinum_price;?>" maxlength="50"  />
											</div>
											<div class="clear"></div>
									</div>
									<div id="white_gold_price">
											<div class="lebelfield floatl">White Gold Price:</div>
											<div class="inputfield floatl">
													<input type="text" name="white_gold_price" value="<?php echo $white_gold_price;?>" maxlength="50"  />
											</div>
											<div class="clear"></div>
									</div>
									<div id="yellow_gold_price">
											<div class="lebelfield floatl">Yellow Gold Price:</div>
											<div class="inputfield floatl">
													<input type="text" name="yellow_gold_price" value="<?php echo $yellow_gold_price;?>" maxlength="50"  />
											</div>
											<div class="clear"></div>
									</div>
									...
									<div id="totalcaratdiv">
											<div class="lebelfield floatl">Total Side Carat:</div>
											<div class="inputfield floatl">
									...
									<table width="100%"><tr><td valign="top">
												...
												<legend>Small Image ( 80 x 80 px)</legend>
												 ...
												 <?php  {
												    	...
												    	if(file_exists(config_item('base_path').'images/rings/'.$small_img) && $small_img !='')echo '<img width="120" height="120" src="'.config_item('base_url').'images/rings/'.$small_img.'" style="width: 80px; height: 80px;"><br />';
										...
										<td>
												<fieldset style="background: #fff;">
												<legend>Gold Image( 80 x 80 px)</legend>
													<center>
												 <?php  {
