<div class="pad10">
   ...
   <div class="pad10">
     <h3 class="newtileheader">Avianneco Collection</h3><br />
      <table>
	        <tr>
		         <td valign="top">
...
if(count($flashfiles)>0)
	{
			if($flashfiles['image45'])
			{
			  ...
			  $image45 =config_item('base_url').'images/rings/icons/45'.$flashfiles['image45']; 
			   // echo config_item('base_url').$image45 ."<br />";
			 // $image45 =(file_exists(config_item('base_url').$image45)) ?  config_item('base_url').$image45 : config_item('base_url').'images/rings/icons/45/45degree.jpg';            
			}
			if($flashfiles['image90'])
			{
		
			  $image90 = config_item('base_url').'images/rings/icons/90'.$flashfiles['image90'];
			  	 // echo config_item('base_url').$image90 ."<br />";
			 // $image90 =(file_exists(config_item('base_url').$image90)) ?  config_item('base_url').$image90 : config_item('base_url').'images/rings/icons/90/90degree.jpg';
			}
			
			if($flashfiles['image180'])
			{
			  $image180 = config_item('base_url'). 'images/rings/icons/180'.$flashfiles['image180'];
			// $image180 =(file_exists(config_item('base_url').$image180)) ?  config_item('base_url').$image180 : config_item('base_url').'images/rings/icons/180/180degree.jpg';
			}
			
			if($flashfiles['image45_bg'])
			{
			   $image45_bg = config_item('base_url').'images/rings/icons/45'.$flashfiles['image45_bg']; 
			 //$image45_bg =(file_exists(config_item('base_url').$image45_bg)) ?  config_item('base_url').$image45_bg : config_item('base_url').'images/rings/icons/45/45.jpg';            
			}
			
			if($flashfiles['image90_bg'])
			{
			   $image90_bg 	= config_item('base_url').'images/rings/icons/90'.$flashfiles['image90_bg'];
			...
			{
			  $image180_bg 	= config_item('base_url').'images/rings/icons/180'.$flashfiles['image180_bg'];
			...
			{
			   $flash1 	= config_item('base_url').$flashfiles['flash1'];
			...
			{
			   $flash2 	= config_item('base_url').$flashfiles['flash3'];
			...
			{
			   $flash3 	= config_item('base_url').$flashfiles['flash3'];
