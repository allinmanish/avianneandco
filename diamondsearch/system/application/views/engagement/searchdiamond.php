				...
				<div class="dbr"></div>	
	  			...
	  			<div>			  			
			  		   <div class="floatl bigcontainerR">
						      <p class="fakaline pad10">Avianneandco makes it easy to design your ring. Follow the three-step process to find the perfect diamond and settings.</p>						     						     
				      </div>
	...
	Priced from <input type="text" name="minprice" id='minprice' value="<?php echo round($minprice);?>" class="w100px price" maxlength="9" onchange="checkMinMaxPrice(this,'maxprice',<?php echo $minprice, ",",$maxprice.",'min'";?>)">-to-<input type="text" name="maxprice" id="maxprice" value="<?php echo round($maxprice); ?>" class="w100px price" maxlength="9" onchange="checkMinMaxPrice(this,'minprice',<?php echo $minprice, ",",$maxprice.",'max'";?>)">				            
      		...
      		<div class="txtcenter">
      			<form id="frmSearchdiamonds" action="<?php echo config_item('base_url');?>diamonds/search/true/false/addtoring" method="POST">
      				<input type="submit" value="Search Diamonds" class="searchdiamondbtn" name="searchdiamonds"> -OR- <input type="submit" value="Resume  Search" class="resumebtn" name="resumesearch">
      			</form> 
      		...
      		<div>
      			...
      			<p class="fakaline pad10">Not sure where to start or what to look for? Contact one of our experienced Diamond & Jewelry Consultants at <a href="#">info@Avianneandco.com</a></p>
      		</div>
