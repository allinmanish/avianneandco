	  ...
	  <div class="bodymid">  
			  	...
			  	<div class="pad10">
			  			...
			  			<?php }
							if($watchesdetails !=''){?>
			  				<div class="resultheader">
							<a href="javascript:void(0)" onclick="viewWatchDetails(<?php echo "'".$watchesdetails['productID']."'";?>, <?php echo "'".$lot."'";?>)">Watch of Lot # <?php echo $inputvalue;?></a> 
			  				</div>
			  				<div class="fakaline">
			  						<?php echo substr($watchesdetails['productDescription'],0,60);?>....<a href="javascript:void(0)" onclick="viewWatchDetails(<?php echo "'".$watchesdetails['productID']."'";?>, <?php echo "'".$lot."'";?>)">(see more)</a>
