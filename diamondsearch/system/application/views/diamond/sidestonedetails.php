...
<div class="floatl pad05">
	  	...
	  	<div class="bodymid">
		  			...
		  			<div class="column floatl">
			  				...
			  				<p><b>Price: </b>$<?php echo  round($totalpriceofsidestone);?>(<small><i>including both diamonds</i></small>)</p>
		  			</div>
		  			<div class="column floatl">
			  				<img src="<?php echo config_item('base_url');?>images/tamal/choose_02.jpg"> <br />
			  				<div class="floatl">
			  	      				<div class="floatl blurleft"></div>
			  	      				<div class="floatl bluemiddle">
                                    	
                                          <form  action="/store/checkout/cart/addloose?product=6396&options[16633]=<?php echo $sidestone1['lot'] ?>&options[16632]=<?php echo $sidestone2['lot']?>&options[16630]=<?php echo $sidestone1['cut']?>&options[16629]=<?php echo $sidestone1['color']?>&options[16634]=<?php echo $pendantsettingsid; ?>&options[16631]=<?php echo  round($totalpriceofsidestone);?>" name="form1" method="post" target="_top">
                            <a href="javascript:void(0)" onclick="document.form1.submit()">Add to cart</a>
                            			</form>
