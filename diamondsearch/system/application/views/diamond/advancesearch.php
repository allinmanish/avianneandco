...
<?php  } else { ?>
 <tr>
 	<td valign="top" class="overall_slide_style">
 		<div class="boxdiv w195px p10">
				   	  <h1 class="slide_heading">Narrow Your Results</h1>
				   	  <div class="dbr"></div>
				   	  <table>
				   	     <tr>
				   	     	<td colspan="2"><span class="diamonds_shape"> Diamonds shape </span></td>
				   	     </tr>
				   	     <tr>
				   	     <td colspan="2">
				   	 ...
				   	 <?   if(!$this->session->userdata('ispremium')){  ?>
				   	     ...
				   	     <tr>
				   	     	<td colspan="2"><span class="select_price_range"> Select your price range </span></td>
				   	     </tr>
				   	     <tr>
					   	     <td  colspan="2">
						...
						<tr>
				   	     ...
				   	     <tr>
				   	     	<td colspan="2"><span class="select_carat"> Select your Carat </span></td>
				   	     </tr>
				   	     <tr>
					   	     <td colspan="2">
						...
						<tr>
				   	    ...
				   	    <tr>
				   	     	<td colspan="2"> <?php if(($this->session->userdata('ispremium'))){ echo '<div style="display:none;">';}else '<div>';?> <span class="select_cut"> Select your Cut </span> <?php echo '</div>'; ?></td>
				   	     </tr>
				   	     <tr>
					   	     <td colspan="2">
						...
						<tr>
				   	    ...
				   	    <tr>
				   	     	<td colspan="2"><span class="select_color"> Select your Color </span> </td>
				   	     </tr>
				   	     <tr>
				   	    ...
				   	    <tr>
				   	     	<td colspan="2"><span class="select_clarity"> Select Clarity </span> </td>
				   	     </tr>
				   	     <tr>
		...
		<div class="boxdiv w195px p10">
				<div>
						<div class="floatl"><h1 class="advance_search"> Advance Search</h1></div>
						<div class="floatr">
				 ...
				 <table width="180" class="tilecontainer" style="display:none;" id="advancesearch">
					 	...
					 	<tr id="symmetryrow" style="display:none;">
					 		<td colspan="2">
						 		<table>
						 			<tr>
							   	     	<td colspan="2"><span class="select_symmety"> Select Symmetry </span></td>
							   	     </tr>
							   	     <tr>
								   	     <td colspan="2">
