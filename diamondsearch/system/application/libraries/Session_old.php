...
// ------------------------------------------------------------------------
	...
	{	
        ...
        $this->set_userdata('mydiamond','');
        $this->set_userdata('myring','');
        $this->set_userdata('mycenterstone','');
        $this->set_userdata('mysidestone','');
        $this->set_userdata('addoption','');
        $basket = array(
        					'diamond' 			=>'',
        					'ring' 				=> array('diamiond' => '','setting' =>''),
        					'threestonering' 	=> array('centerstone' => '','sidestone' =>''),
        					'diamonodpendant'	=> array('diamond' =>'', 'setting' =>''),
        					'finalproduct'		=> array()
        				);
        $this->set_userdata('basket' , $basket);
