...
function create_captcha($data = '', $img_path = '', $img_url = '', $font_path = '')
{
   ...
   // $angle    = ($length >= 6) ? rand(-($length-6), ($length-6)) : 0;
    ...
    $bg_color        = ImageColorAllocate($im, 247,247,247);
    $border_color    = ImageColorAllocate($im, 247,247,247);
    $text_color        = ImageColorAllocate($im, 0, 0, 0);
    $grid_color        = imagecolorallocate($im, 189, 189, 189);
    ...
    */
    ...
    return array('word' => substr($word,0,5), 'time' => $now, 'image' => $img,'src'=>$img_url.$img_name);
}
}
?>