...
config. BalloonImgPath		= base_url+"third_party/dhtmltooltips/tip_balloon/" // Path to images (border, corners, stem), in quotes. Path must be relative to your HTML file.
