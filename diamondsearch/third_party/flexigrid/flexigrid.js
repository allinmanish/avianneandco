	...
	$.addFlex = function(t,p)
	{
		...
		var g = {
			...
			addData: function (data) { //parse data
				...
				this.loading = false;
				if(data.total <= 0)
				$.facebox('<center><h3>Please check search filters</h3><img src="' + base_url + 'images/noresultfound.png"></center>');
				else
				$.facebox.close();
			...
			populate: function () { //get latest data
				...
				$.facebox('<center><img src="' + base_url + 'images/loading.gif" border="0" alt="loading"></center>');
