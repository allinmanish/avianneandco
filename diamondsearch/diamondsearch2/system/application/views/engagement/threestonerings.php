				...
				<?php if(isset($threestonerings)){
					foreach ($threestonerings as $threestone){?>
						<div class="floatl ringbox txtcenter">							
                            ...
                            <p><a href="#" onclick="viewThreestoneRingsDetails(<?php echo $threestone['stock_number'];?>,<?php echo $centerstoneid;?>,<?php echo $sidestoneid1;?>,<?php echo $sidestoneid2;?>)">View Details</a></p>
