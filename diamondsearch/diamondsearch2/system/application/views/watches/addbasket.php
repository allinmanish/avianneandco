			  ...
			  $flash3 =(file_exists(config_item('base_path').$flash3)) ?  config_item('base_url').$flash3 : config_item('base_url').'flash/180.swf';
			 	 ...
			 	 <div>
			 	    <div class="floatr" style="padding-top: 5px;">
						&nbsp; Total : $<?php echo number_format(round($totalprice),',');?><br>
				 	</div>
					<div class="floatr blueright"></div>
					<div class="floatr bluemiddle"><a href="#" onclick=" <?php echo $onclickfunction;?>">add this ring to basket</a></div>
								...
								<tbody>
									...
									<tr>
																 ...
																 <?php if(isset($ringdetails['metal'])){?>
																	...
																	<td width="120" class="brownback"><?php echo $ringdetails['metal'];?><br /></td>
																</tr>
																<?php }?>
																 <?php if(isset($ringdetails['section'])){?>
																<tr>
																	<td width="120" class="brownback">Section</td>
																	<td width="120" class="brownback">Demo collection<?php //echo $ringdetails['section'];?><br /></td>
				        ...
				        <tr>
						 ...
						 <tr>
						   ...
						   <div class="floatl padl10 margin10">
							<ul>
								<li>i.&nbsp;&nbsp;Fed-x</li>
								<li>ii.&nbsp;The ring Will arrive in 2-4 Businness Days. Arrival depends on the specific diamond selected. Intercarats</li>
