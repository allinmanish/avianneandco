<div class="floatl pad05">
	  	...
	  	<div class="bodymid">
	  			...
	  			<?php $img = file_exists(config_item('base_path').'images/'.$details['big_image']) ? config_item('base_url').'images/'.$details['big_image'] : config_item('base_url').'images/rings/noimage_sm.jpg';  ?>
