	  	...
	  	<div class="bodymid">
			...
			<div>			  			
			  		  <div class="floatl bigcontainerR">
						      <p class="fakaline pad10">Intercarats make it easy to design your own three stone ring. Follow the three-step process to find the perfect diamond and settings.</p>						     						     
				      </div>
