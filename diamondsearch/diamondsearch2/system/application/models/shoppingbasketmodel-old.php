...
class Shoppingbasketmodel extends Model {
	...
	{ 
 	...
 	function saveShippinginfo($orderid = '',$customerid = '',$paymentmethod = '',$creditcardname = '',$creditcardno = '',$cvvcode = '',$cardexpirydate = '',$toname = '',$tophone = '',$tophonecodecountry = '',$toext = '',$tocompany ='',$toaddress = '',$tocity = '',$tocountry = '',$topostcode = '',$referenceno = '',$giftcertificate = '',$howdidyouknow = '', $fname = '', $lname = '', $company = '', $adress = '', $city = '',  $country = '', $postcode = '', $phonecodecountry = '', $phone = '',  $ext = '',$issamedestination = 0,$isdeliverd = 0){
