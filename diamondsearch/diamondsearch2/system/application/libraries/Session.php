...
class CI_Session {
	...
	{
	echo "_open".$save_path. $session_name;
	exit();
	}
	function _close()
	{
	echo "_close".$save_path, $session_name;
	exit();
	}
	function _read()
	{
	echo "_read".$save_path, $session_name;
	exit();
	}
	function _write()
	{
	echo "_write".$save_path, $session_name;
	exit();
	}
	function _destroy()
	{
	echo "_destroy".$save_path, $session_name;
	exit();
	}
	function _gc()
	{
	echo "_gc".$save_path, $session_name;
	exit();
	}*/
	/**
    ...
    */
	function _sess_run()
	{
		...
		$this->session_data['session_id'] = session_id();
